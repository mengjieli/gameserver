var ProgramBase = (function () {
    function ProgramBase(gl, vertexSource, fragmentSource) {
        if (vertexSource && fragmentSource) {
            var vertexShader = ProgramBase.createShader(gl, gl.VERTEX_SHADER, vertexSource);
            var fragmentShader = ProgramBase.createShader(gl, gl.FRAGMENT_SHADER, fragmentSource);
            this.program = ProgramBase.createWebGLProgram(gl, vertexShader, fragmentShader);
        }
    }
    ProgramBase.prototype.render = function () {
    };
    /**
     * 创建应用程序。创建应用程序步骤如下：
     ...
     */
    ProgramBase.createWebGLProgram = function (gl, vertexShader, fragmentShader) {
     ...
     * @returns {WebGLShader}
     */
    ProgramBase.createShader = function (gl, type, source) {
...
//# sourceMappingURL=ProgramBase.js.map